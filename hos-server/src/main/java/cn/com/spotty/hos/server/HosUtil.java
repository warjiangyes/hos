...
public class HosUtil {
    static final byte[][] OBJ_REGIONS = new byte[][]{Bytes.toBytes("1"), Bytes.toBytes("4"), Bytes.toBytes("7")};
    ...
    static {
        try {
            byte[][] qualifiers = new byte[][]{HosUtil.DIR_SEQID_QUALIFIER, HosUtil.OBJ_LEN_QUALIFIER, HosUtil.OBJ_MEDIATYPE_QUALIFIER};
